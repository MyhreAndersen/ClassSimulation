...
//		picture = new ScrollablePicture(bee,50);// columnView.getIncrement());
		picture = new JLabel();
		picture.setAutoscrolls(true); //enable synthetic drag events
		picture.setText("No picture found.");
		picture.setHorizontalAlignment(SwingConstants.CENTER);
		picture.setOpaque(true);
		picture.setBackground(Color.white);
		picture.setPreferredSize(new Dimension(320, 1480));
